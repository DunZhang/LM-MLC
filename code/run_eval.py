...
if __name__ == "__main__":
    ...
    # model_dir = "../output/trained_models/aapd_label_mask_mlm_v1/avg_best_model"
    model_dir = "../output/trained_models/gaic_labelmask_v1/avg_best_model"
    ...
    dev_data_iter = BERTDataIter(data_path="../data/format_data/gaic_dev.txt", tokenizer=model.tokenizer,

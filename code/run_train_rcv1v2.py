...
if __name__ == "__main__":
    ...
    # 输出信息
    conf.log_step = 10
    conf.save_step = 4000  # do a evaluate and save best model
    ...
    # 模板位置
    conf.pattern_pos = "end"  # begin or end
    ...
    # 训练时标签mask的顺序
    conf.mask_order = "random"  # random:每次都是随机，List[int] 固定的mask顺序
    ...
    # 相关路径
    conf.train_data_path = "../data/format_data/rcv1v2_train.txt"
    conf.dev_data_path = "../data/format_data/rcv1v2_test.txt"
    conf.data_sep = "\t"  # text与label的sep
    # 输出路径
    conf.out_dir = "../output/trained_models/test_baseline"
    conf.desc = ""
    train_model(conf)
